...
const Login = () => {
    ...
    const handleSubmit = async () => {
        ...
        if (response.ok) {
            ...
            alert("Login success! Redirecting home.")
            navigate("/")
        }
        else {
            alert("Login failed. Make sure your email and password are correct.")
        }
  ...
  return (
    <div>
        ...
        <div className='flex-col flex items-center justify-center'>
            <div className='text-5xl my-5 mx-10'>Login</div>
            <div className="bg-sky-300 w-180 h-180 relative rounded-2xl shadow-2xl">
                ...
                <div className="relative left-10">
                    <button onClick = {handleSubmit} className="rounded px-4 py-2 bg-green-500 text-white">Login</button>
                </div>
